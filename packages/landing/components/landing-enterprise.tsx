...
import { ArrowRight, Cloud, LockKeyhole, Rocket, Sparkles, Workflow } from "lucide-react";
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center pb-3 pt-1 md:pb-4 md:pt-2">
        ...
        <main className="mx-auto flex w-full max-w-5xl flex-col gap-16 px-6 pb-24 md:gap-20 md:px-8 md:pb-28">
          <section className="max-w-4xl">
            <div className="mb-4 inline-flex items-center rounded-full border border-white/70 bg-white/70 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.24em] text-slate-500 shadow-sm backdrop-blur-sm">
              OpenWork Enterprise
            </div>

            <h1 className="mb-6 text-4xl font-medium leading-[1.05] tracking-tight md:text-5xl lg:text-6xl">
              Safe, permissioned <span className="font-pixel mx-1 inline-block align-middle text-[1.05em] font-normal">AI</span>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3 text-[13px] text-slate-500">
              <div className="inline-flex items-center gap-2 rounded-full border border-white/70 bg-white/70 px-3 py-2 shadow-sm backdrop-blur-sm">
          ...
          <section className="grid gap-6 lg:grid-cols-[1.08fr_0.92fr] lg:items-start">
            <div className="space-y-6">
              <div className="rounded-[2rem] border border-white/70 bg-white/80 p-6 shadow-[0_20px_60px_-24px_rgba(15,23,42,0.18)] backdrop-blur-md md:p-8">
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  {focusAreas.map((item) => (
                    ...
                    >
                      <div className="text-sm font-medium text-[#011627]">{item}</div>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="grid gap-6 md:grid-cols-3">
                {deploymentModes.map((mode) => {
                  ...
                  return (
                    <div
                      key={mode.title}
                      className="rounded-[2rem] border border-white/70 bg-white/72 p-6 shadow-[0_20px_60px_-24px_rgba(15,23,42,0.18)] backdrop-blur-md"
                    >
              ...
              <div className="rounded-[2rem] border border-white/70 bg-gradient-to-br from-white/88 to-white/72 p-6 shadow-[0_20px_60px_-24px_rgba(15,23,42,0.18)] backdrop-blur-md md:p-8">
                ...
                <div className="mt-6 inline-flex items-center gap-2 text-[14px] font-medium text-slate-600">
                  <Link href="/den" className="inline-flex items-center gap-2 transition-colors hover:text-[#011627]">
