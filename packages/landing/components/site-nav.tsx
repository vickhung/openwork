        ...
        <div className="mb-12 flex items-center justify-between pt-4 md:mb-16">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              ...
              className="hidden items-center gap-2 rounded-full border border-white/80 bg-white/80 px-3 py-2 text-[14px] font-medium text-slate-500 shadow-sm backdrop-blur-sm transition-colors hover:text-[#011627] sm:flex"
              rel="noreferrer"
              target="_blank"
        ...
        {mobileOpen ? (
          <div className="mb-8 rounded-[2rem] border border-white/80 bg-white/85 p-4 shadow-[0_20px_60px_-24px_rgba(15,23,42,0.22)] backdrop-blur-xl md:hidden">
            ...
            <div className="mt-4 flex flex-col gap-3">
              ...
              <a
                href="https://github.com/different-ai/openwork"
                className="inline-flex items-center justify-center gap-2 rounded-full border border-white/80 bg-white/80 px-4 py-2 text-sm font-medium text-slate-500 shadow-sm backdrop-blur-sm transition-colors hover:text-[#011627]"
                rel="noreferrer"
                target="_blank"
              >
                <svg
